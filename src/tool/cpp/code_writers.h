...
namespace winrt::@::implementation
{
    ...
    inline void write_component_factory_interfaces(writer& w, std::vector<factory_type> const& factories)
    {
        for (auto&& factory : factories)
        {
            if (!factory.type)
...
namespace winrt::@::implementation
{
    ...
    inline void write_component_member_declarations(writer& w, TypeDef const& type, std::vector<factory_type> const& factories)
    {
        auto type_name = type.TypeName();
