...
namespace winrt::Component::Edge::implementation
{
    ...
    {
        ThreeClass() = default;
        ThreeClass(int32_t a, int32_t b, int32_t c){ m_first = a; m_second = b; m_third = c; }
        void Method(int32_t a, int32_t b, int32_t c) { m_first = a; m_second = b; m_third = c; }
        static void StaticMethod(int32_t a, int32_t b, int32_t c) { m_first = a; m_second = b; m_third = c; }
        int32_t First() { return m_first;}
        int32_t Second() { return m_second;}
        int32_t Third() { return m_third;}
